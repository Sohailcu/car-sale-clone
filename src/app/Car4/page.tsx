...
export default function Car1 () {
    return (
      <div className="mt-5 mx-48 bg-gray-100 p-5 mb-5">
        <h1 className="text-3xl text-blue-950 font-bold font-sans py-4 text-center "><ins>Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs</ins></h1>
          <div className="flex justify-center mt-5">
            <Image 
              src="/images/hondaCivics.jpg"
              alt="pic4"
              width={400}
              height={300}
              />
        ...
        <h1 className="text-center mt-5 text-xl font-semibold">Vehicle Description</h1>
          ...
          <div className="flex justify-center gap-4 text-sm mt-4">
            ...
            <div><b>Engine</b> 1498 cc</div>
            <div><b>Condition</b> 8.5 / 10</div>
            <div><b>Driven</b> 8,500 KM</div>
            <div><b>Suspension type</b> Soft Suspension</div>
          </div>
      
          <div className="flex justify-center gap-4 text-sm mt-2">
            <div><b>Avg</b> 14 Km per ltr</div>
            <div><b>Transmission</b> Automatic</div>
            <div><b>Fuel Type</b> High Octane</div>
        </div>

         <h1 className="text-green-600 text-2xl mt-8 font-sans font-bold text-center">PKR 57,50,000</h1>

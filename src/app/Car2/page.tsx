...
export default function Car1 () {
    return (
      <div className="mt-5 mx-48 bg-gray-100 p-5 mb-5">
        <h1 className="text-3xl text-blue-950 font-bold font-sans py-4 text-center "><ins>Suzuki Alto 2024 Price in Pakistan, Images, Reviews & Specs</ins></h1>
        ...
        <h1 className="text-center mt-5 text-xl font-semibold">Vehicle Description</h1>
         ...
         <h1 className="text-green-600 text-2xl mt-8 font-sans font-bold text-center">PKR 45,00,000</h1>
